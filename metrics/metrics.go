...
func NewNodeMetrics() *NodeMetrics {
	...
	return &NodeMetrics{
		...
		BlocksImported:   r.Counter("layer1_blocks_imported_total", "Blocks accepted from peers."),
		BlocksProduced:   r.Counter("layer1_blocks_produced_total", "Blocks sealed by this validator."),
		BlocksRejected:   r.Counter("layer1_blocks_rejected_total", "Blocks that failed verification."),
		TxAccepted:       r.Counter("layer1_transactions_accepted_total", "Transactions admitted to the pool."),
		TxRejected:       r.Counter("layer1_transactions_rejected_total", "Transactions the pool refused."),
		AttestationsSeen: r.Counter("layer1_attestations_total", "Validator attestations recorded."),
		Equivocations:    r.Counter("layer1_equivocations_total", "Validators caught signing conflicting attestations."),
		...
		PeerCount:      r.Gauge("layer1_peers", "Connected peers."),
		TxPoolPending:  r.Gauge("layer1_txpool_pending", "Executable transactions in the pool."),
		TxPoolQueued:   r.Gauge("layer1_txpool_queued", "Transactions waiting on a nonce gap."),

		BlockExecution: r.Histogram("layer1_block_execution_seconds", "Time to execute and verify a block.", nil),
		BlockGasUsed: r.Histogram("layer1_block_gas_used", "Gas used per block.",
			[]float64{100000, 1000000, 5000000, 10000000, 15000000, 20000000, 30000000}),
		RPCLatency: r.Histogram("layer1_rpc_latency_seconds", "Time to serve a JSON-RPC call.", nil),
	}
}
